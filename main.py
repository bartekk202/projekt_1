...
def add_user():
    ...
    users.append(User(name = zmienna_imie, surname = zmienna_nazwisko, location = zmienna_miejscowosc))
    print(users)
...
# ramka_lista_redakcji
label_lista_redakcje = Label(ramka_lista_obiektow, text="Redakcje")
label_lista_redakcje.grid(row=0, column=0, columnspan=3)
